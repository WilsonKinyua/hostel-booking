    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.complaints.update", [$complaint->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('complaint_content') ? 'is-invalid' : '' }}" name="complaint_content" id="complaint_content">{{ old('complaint_content', $complaint->complaint_content) }}</textarea>
