    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.payments.update", [$payment->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_amount') ? 'is-invalid' : '' }}" type="number" name="total_amount" id="total_amount" value="{{ old('total_amount', $payment->total_amount) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_paid') ? 'is-invalid' : '' }}" type="number" name="total_paid" id="total_paid" value="{{ old('total_paid', $payment->total_paid) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transactionid') ? 'is-invalid' : '' }}" type="text" name="transactionid" id="transactionid" value="{{ old('transactionid', $payment->transactionid) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('notes') ? 'is-invalid' : '' }}" name="notes" id="notes">{{ old('notes', $payment->notes) }}</textarea>
                @if($errors->has('notes'))
