    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.tenants.update", [$tenant->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('middle_name') ? 'is-invalid' : '' }}" type="text" name="middle_name" id="middle_name" value="{{ old('middle_name', $tenant->middle_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('last_name') ? 'is-invalid' : '' }}" type="text" name="last_name" id="last_name" value="{{ old('last_name', $tenant->last_name) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Tenant::GENDER_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('gender') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="gender_{{ $key }}" name="gender" value="{{ $key }}" {{ old('gender', $tenant->gender) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('department') ? 'is-invalid' : '' }}" type="text" name="department" id="department" value="{{ old('department', $tenant->department) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone" id="phone" value="{{ old('phone', $tenant->phone) }}" required>
                @if($errors->has('phone'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $tenant->email) }}" required>
                @if($errors->has('email'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_number') ? 'is-invalid' : '' }}" type="number" name="id_number" id="id_number" value="{{ old('id_number', $tenant->id_number) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('home_address_line_1') ? 'is-invalid' : '' }}" type="text" name="home_address_line_1" id="home_address_line_1" value="{{ old('home_address_line_1', $tenant->home_address_line_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('home_address_line_2') ? 'is-invalid' : '' }}" type="text" name="home_address_line_2" id="home_address_line_2" value="{{ old('home_address_line_2', $tenant->home_address_line_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('emergency_person_name') ? 'is-invalid' : '' }}" type="text" name="emergency_person_name" id="emergency_person_name" value="{{ old('emergency_person_name', $tenant->emergency_person_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('emergency_person_phone_number_1') ? 'is-invalid' : '' }}" type="text" name="emergency_person_phone_number_1" id="emergency_person_phone_number_1" value="{{ old('emergency_person_phone_number_1', $tenant->emergency_person_phone_number_1) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('emergency_person_phone_number_2') ? 'is-invalid' : '' }}" type="text" name="emergency_person_phone_number_2" id="emergency_person_phone_number_2" value="{{ old('emergency_person_phone_number_2', $tenant->emergency_person_phone_number_2) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('room') ? 'is-invalid' : '' }}" name="room_id" id="room_id" required>
                    @foreach($rooms as $id => $entry)
                        <option value="{{ $id }}" {{ (old('room_id') ? old('room_id') : $tenant->room->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('room'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('extra_note') ? 'is-invalid' : '' }}" name="extra_note" id="extra_note">{{ old('extra_note', $tenant->extra_note) }}</textarea>
